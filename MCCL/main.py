...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='huri', help='dataset name - pgr, gdpr, huri')
    ...
    #old
    parser.add_argument('--in_file', type=str, default="../data/HuRI2.edgelist", help="in_file")
    parser.add_argument('--network_ratio', type=float, default=1, help='Remain links in network. Default is 1')
    parser.add_argument('--batch', type=int, default=64, help='Batch size. Default is 128.')
    ...
    print("for test:")
    auroc, p, r, f1, predictions, predictions_proba = eval_best_model(args, model, test_data_loader)
    ...
    print("for train:")
    auroc, p, r, f1, predictions, predictions_proba = eval_best_model(args, model, train_data_loader)
    ...
    print("for val:")
    auroc, p, r, f1, predictions, predictions_proba = eval_best_model(args, model, val_data_loader)
